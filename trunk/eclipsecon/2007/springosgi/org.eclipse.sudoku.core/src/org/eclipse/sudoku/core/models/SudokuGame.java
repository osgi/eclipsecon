...
public class SudokuGame {
	...
	Collection<SudokuBoardFactory> boardFactories;
	public void setBoardFactories(Collection<SudokuBoardFactory> factories) {
		this.boardFactories = factories;
	}
	public List<Factory> getFactories() {
		List<Factory> factories = new ArrayList<Factory>();
		for (SudokuBoardFactory boardFactory : boardFactories) {
			factories.add(new Factory(boardFactory));
		}
		return factories;
	}
	...
	Collection<SudokuBoardSolver> boardSolvers;
	public void setBoardSolvers(Collection<SudokuBoardSolver> solvers) {
		this.boardSolvers = solvers;
	}
	public List<Solver> getSolvers() {
		List<Solver> solvers = new ArrayList<Solver>();
		for (SudokuBoardSolver boardSolver : boardSolvers) {
			solvers.add(new Solver(boardSolver));
		}
		return solvers;
	}
}
